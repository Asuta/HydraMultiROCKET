...
def main():
    ...
    # 加载测试数据
    data_path = "output/prepared_data_new/test_dataset.npz"
    ...
    try:
        ...
        # 保存图表
        plt.savefig('output/probability_distribution_new.png')
        print("概率分布图已保存到 output/probability_distribution_new.png")
